...
public:
	...
	Number_2048bit greatest_common_divisor(const Number_2048bit&, const Number_2048bit&);
	Number_2048bit least_common_multiple(const Number_2048bit&, const Number_2048bit&);
};
